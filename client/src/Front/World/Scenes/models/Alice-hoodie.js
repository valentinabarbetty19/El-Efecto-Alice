...
export function Alice(props) {
  const { nodes, materials } = useGLTF("/assets/models/Alice/Alice-hoodie.glb");
  ...
  const { animations: turningLeftAnimation } = useFBX(
    "/assets/models/Alice/Animations/LeftTurn.fbx"
  );
...
useGLTF.preload("/assets/models/Alice/Alice-hoodie.glb");
