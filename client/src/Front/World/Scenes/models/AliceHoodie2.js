...
export function AliceHoodie2(props) {
  ...
  const [scaleAlice, setScale] = useState(4);
  ...
  useEffect(() => {
    ...
    if((props.animation === 68) || (props.animation === 70) || (props.animation === 71) || (props.animation === 16) || (props.animation === 18) || (props.animation === 20) ){
      setPositionZ(0)
      setPositionX(-3)
      setPositionY(-5)
      setRotationy( Math.PI / 2)
    ...
    if((props.animation === 69) || (props.animation === 17)  || (props.animation === 19)){
      setPositionZ(0)
      setPositionX(-3)
      setPositionY(-5)
      setRotationy( Math.PI / 2)
  ...
  return (
    ...
    position-y={positiony} scale={scaleAlice}>
      <group name="Scene">
        <group name="Armature">
          <skinnedMesh
            name="EyeLeft"
