...
Author: The Center for Digital Humanities UArizona (https://sketchfab.com/UofA-CDH)
License: CC-BY-4.0 (http://creativecommons.org/licenses/by/4.0/)
Source: https://sketchfab.com/3d-models/updated-hospital-room-750ab38d2cba46729bd495820d001325
Title: Updated Hospital Room
*/
...
export function Hospital(props) {
  ...
  return (
    <group {...props} dispose={null} scale={1}  position-z={27} position-y={-15} rotation-x={Math.PI /10} rotation-y={Math.PI/10}>
      <group scale={0.01}>
        <group
