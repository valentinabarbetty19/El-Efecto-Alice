...
export const introArray = [
  ...
  },
  {
    ...
    id: 22,
    imageUrl: "/assets/img/scenarios/house-door-outside-2.png",
    mensaje: "Alice: ¿Qué hago? ¿Voy o no voy? (Presiona las teclas ← o → para desplazarte)",
...
export const bifur2Array = [
  ...
  },
  {
    //ANIMACIÓN 3D
    id: 54,
    mensaje: "No sabe por cuál camino ellos se fueron. ¿Por cuál calle debería ir? ¿Calle 1 o Calle 2? (Presiona las teclas ← o → para desplazarte)",
