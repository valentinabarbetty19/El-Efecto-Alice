...
export function Arrow(props) {
  const { nodes, materials } = useGLTF("/assets/models/Scenarios/arrow2.glb");
  ...
  useEffect(() => {
    if (props.id_pos === 54) {
      ...
      setPositionX(-95);         
      setPositionY(30);      //abajo
      setPositionZ(-64); //izquierda
    }
...
useGLTF.preload("/assets/models/Scenarios/arrow2.glb");
